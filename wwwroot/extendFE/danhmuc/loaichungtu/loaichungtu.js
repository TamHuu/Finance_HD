...
$(document).ready(function () {
    table = $('#Table').DataTable({
        columnDefs: [
            ...
            { width: '150px', className: 'text-center', targets: [3,4], orderable: false },
        ],
        sorting: true, 
        language: {
            "decimal": "",
...
function loadDanhSach() {
    $.ajax({
        url: "/DocumentType/getListDocumentType",
        method: "GET",
...
function Edit(row) {
    ...
    window.open('/DocumentType/Edit?ma=' + firstCellValue, '_blank');
