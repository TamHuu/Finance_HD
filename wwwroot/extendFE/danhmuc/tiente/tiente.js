...
$(document).ready(function () {
    table = $('#Table').DataTable({
        columnDefs: [
            ...
            { width: '300px', className: 'dt-left dt-head-center', targets: [1, 2], orderable: false },
            { width: '150px', className: 'text-center', targets: [3], orderable: false },
...
function Edit(row) {
    ...
    window.open('/Monetary/Edit?ma=' + firstCellValue, '_blank');
