...
$(document).ready(function () {
    table = $('#Table').DataTable({
        columnDefs: [
            ...
            {  className: 'dt-left dt-head-center', targets: [1, 2], orderable: false },
...
function loadDanhSach() {
    $.ajax({
        url: "/IdentifiedAccount/getListTaiKhoanDinhDanh",
        method: "GET",
...
function Edit(row) {
    ...
    window.open('/IdentifiedAccount/Edit?ma=' + firstCellValue, '_blank');
