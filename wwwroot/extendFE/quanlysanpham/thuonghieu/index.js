...
$(document).ready(function () {
    table = $('#Table').DataTable({
        columnDefs: [
            ...
            { width: '200px', "targets": [2], className: 'text-left' },
            { width: '100px', "targets": [ 3, 4, 5], className: 'text-left' },
            { width: '600px', "targets": [6], className: 'text-left' },
...
function drawDanhSach(data) {
    ...
    <span>|</span>
    <button class="btn btn-danger btn-sm btnDelete" data-id="${brand.id}" title="Xóa">
...
function Edit(row) {
    ...
    window.open('/Admin/Brand/Edit?ma=' + firstCellValue, '_blank');
