...
$(document).ready(function () {
    table = $('#Table').DataTable({
        columnDefs: [
            ...
            { width: '50px', className: 'text-center', targets: [1,6] },
            { width: '400px', "targets": [2,5], className: 'text-left' },
            { width: '200px', "targets": [3], className: 'text-left' },
            { width: '100px', "targets": [ 4], className: 'text-left' },
...
function loadDanhSach() {
    $.ajax({
        url: "/Admin/Supplier/GetListSupplier",
        method: "GET",
...
function drawDanhSach(data) {
    ...
    <span>|</span>
    <button class="btn btn-danger btn-sm btnDelete" data-id="${supplier.id}" title="Xóa">
...
function Edit(row) {
    ...
    window.open('/Admin/Supplier/Edit?ma=' + firstCellValue, '_blank');
